...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage!!.setOnClickListener {
            ...
            clickLemonImage()
            //val toast = Toast.makeText(this, "state after button is "+lemonadeState, Toast.LENGTH_SHORT)
            //toast.show()
        }
    ...
    private fun clickLemonImage() {
        ...
        if (lemonadeState == "select") {
            ...
            // Set state to SQUEEZE
            lemonadeState = "squeeze"

            // Set a random lemon size using the LemonTree class
            lemonSize = LemonTree().pick()

            // Set the squeezeCount to zero because we haven't done any squeezing yet
            squeezeCount = 0

            // Now change the image to a lemon for squeezing, and update the text
            setViewElements()
    ...
    private fun setViewElements() {
        ...
        if (lemonadeState == "select") {
            ...
            // Update image to a lemon
            lemonImage!!.setImageResource(R.drawable.lemon_squeeze)
        } else if (lemonadeState == "drink") {
            // Update text
            textAction.setText(R.string.lemon_drink)

            // Update image to a full glass
